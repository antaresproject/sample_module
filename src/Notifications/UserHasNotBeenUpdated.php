...
class UserHasNotBeenUpdated extends AbstractItemNotification {
    ...
    public static function templates() : TemplatesCollection {
        return TemplatesCollection::make('Module Item Not Updated', ItemNotUpdated::class)
    ...
    protected static function mailMessage() {
        $subject    = 'Module item has not been updated';
